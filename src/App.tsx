...
推荐比分：核心主推 ${activePrediction.recommendedScores?.primary || "2-0"}，稳健主控 ${activePrediction.recommendedScores?.stable || "1-0"}。`
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 pb-12 flex flex-col font-sans" id="root-app">
      ...
      {/* Footer / GitHub Link */}
      <footer className="mt-8 pb-6 text-center text-[11px] font-semibold text-slate-500">
        <p className="flex items-center justify-center gap-1.5">
          <a 
            href="https://github.com/luyi-he/2026-worldcup" 
            target="_blank" 
          ...
          >
            ...
            <span className="underline decoration-slate-300 underline-offset-2 hover:decoration-slate-900">GitHub 开源项目 (luyi-he/2026-worldcup)</span>
          </a>
        </p>
        <p className="mt-1.5">如果您觉得本系统有用，欢迎前往 GitHub 为我们点亮 ⭐ Star！</p>
      </footer>
    </div>
  );
}
